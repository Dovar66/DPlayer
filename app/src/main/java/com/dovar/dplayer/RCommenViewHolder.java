...
public class RCommenViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setImageUrl(int viewId, String url) {
        ...
        if (iv != null) {
            if (!TextUtils.isEmpty(url)) {
                ...
                setImageResource(viewId, R.drawable.default_pic_big);
            }
        }
    }
    ...
    public void loadCircleImage(int viewId, String url) {
        ...
        if (iv != null) {
            if (!TextUtils.isEmpty(url)) {
                PhotoUtil.loadCirclePhoto(iv, url, R.drawable.head, R.drawable.head);
            } else {
                PhotoUtil.loadLocalCirclePhoto(iv, R.drawable.head);
            }
        }
    }
