...
public class TouchImageView extends ImageView {
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e)
        {
            /*if(doubleTapListener != null) {
            	return doubleTapListener.onSingleTapConfirmed(dropVideoFrames);
            }
        	return performClick();*/
    ...
    private void printMatrixInfo() {
    	float[] n = new float[9];
    	matrix.getValues(n);
    	LogUtil.d(DEBUG, "Scale: " + n[Matrix.MSCALE_X] + " TransX: " + n[Matrix.MTRANS_X] + " TransY: " + n[Matrix.MTRANS_Y]);
    }
...
//        sourceBitmap = bitmap;
        int screenWidth = ((WindowManager) (MyApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
        int screenHeight = ((WindowManager) (MyApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
        bitmap = resizeImage(bitmap, screenWidth, screenHeight);
