...
public class A {
    ...
    public void a(Context var1) {
        synchronized (this.c) {
            if (var1 != null && !this.j) {
                ...
                this.mHandlerThread = new HandlerThread("QosBroadcastManager");
    ...
    public boolean a(Intent var1) {
        synchronized (this.c) {
            if (this.i && this.mContext != null && this.j) {
                String var3 = var1.getAction();
                String var4 = var1.resolveTypeIfNeeded(this.mContext.getContentResolver());
        ...
        while (true) {
            ...
            for (int var6 = 0; var6 < var1.length; ++var6) {
                ...
                for (int var4 = 0; var4 < var7.b.size(); ++var4) {
                    (var7.b.get(var4)).b.onReceive(this.mContext, var7.a);
                }
            }
        }
    }
